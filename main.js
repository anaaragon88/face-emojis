...
document.addEventListener('DOMContentLoaded', () => {
  const start = async() => {
    ...
    const textures = {};
    textures['happy'] = await loadTexture('./assets/openmoji/happy.png');
    textures['angry'] = await loadTexture('./assets/openmoji/angry.png');
    textures['sad'] = await loadTexture('./assets/openmoji/sad.png');
    textures['neutral'] = await loadTexture('./assets/openmoji/neutral.png');
